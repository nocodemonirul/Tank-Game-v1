...
export class Player {
  ...
  constructor(scene: THREE.Scene, world: CANNON.World) {
    ...
    this.body.addEventListener("collide", (e: any) => {
      // Check if it's a bullet (we can identify bullets by mass or a custom property)
      if (e.body && e.body.mass === 10) { // Tank bullets have mass 10
        this.takeDamage(10);
      }
    });
  }
